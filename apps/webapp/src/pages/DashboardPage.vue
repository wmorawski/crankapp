    ...
    <div class="lg:pl-72">
          ...
          <div class="flex items-center gap-x-4 lg:gap-x-6">
            ...
            <Menu as="div" class="relative">
              <MenuButton class="-m-1.5 flex items-center p-1.5">
                ...
                <CrAvatar :username="currentUser.username" :avatarUrl="currentUser.avatarUrl" />
                <span class="hidden lg:flex lg:items-center">
                  <span class="ml-4 text-sm font-semibold leading-6 text-gray-900" aria-hidden="true">{{currentUser.username}}</span>
      ...
      <main class="py-10">
        <div class="px-4 sm:px-6 lg:px-8">
          <CrButton variant="primary" size="default">
            Przycisk
          </CrButton>
        </div>
      </main>
...
import {CrAvatar, CrButton} from '@crank/ui';
